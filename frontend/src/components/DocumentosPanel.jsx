...
const s = {
  wrap: { padding: '16px 0' },
  h3: { fontSize: 14, color: '#0B2E6E', margin: '16px 0 8px' },
  row: { display: 'flex', gap: 12, marginBottom: 8 },
  col: { flex: 1 },
  label: { display: 'block', fontSize: 12, color: '#5a6b8c', marginBottom: 4 },
  input: {
    width: '100%',
    padding: '8px 10px',
    borderRadius: 6,
  ...
  empty: { fontSize: 12, color: '#8b97b3' },
  item: {
    display: 'flex',
    alignItems: 'center',
    gap: 10,
