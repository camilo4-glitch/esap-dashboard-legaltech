...
const CALCULADOS = {
  ...
  avancePlaneacion: 'avance_planeacion',
  avancePrecontractual: 'avance_precontractual',
  origenEstructuracion: 'origen_estructuracion',
  avanceEjecucion: 'avance_ejecucion',
  avanceLegalizacion: 'avance_legalizacion',
  terminoDias: 'termino_dias',
  faseEtiqueta: 'fase_etiqueta',
  terminoFuente: 'termino_fuente',
